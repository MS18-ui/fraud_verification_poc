...
# ---------------------------------------------------------------------------
# Navy/blue theme, matched to the reference design: deep navy page
# background, a floating white content card, bright blue primary accent
# for buttons/links/headings, and a light muted tint for nested sub-cards
# (Vendor Response fields, Composite View, etc.) so they read as distinct
# sections against the white page card. Values were sampled directly from
# the reference screenshot (navy #10166d, accent blue #235ae4).
# ---------------------------------------------------------------------------
PAGE_BG = "#10166d"
SIDEBAR_BG = "#ffffff"
CARD_BG = "#ffffff"
...
<style>
    ...
    .block-container {{
        max-width: 1180px; padding: 2rem 2.5rem 3rem; margin-top: 1.5rem;
    ...
    .explain-card {{
        ...
        padding: 16px 20px; background: {INNER_BG};
    }}
    ...
    @keyframes step-trail-pulse {{
        0%   {{ box-shadow: 0 0 0 0 rgba(35,90,228,0.35); }}
        70%  {{ box-shadow: 0 0 0 7px rgba(35,90,228,0); }}
        100% {{ box-shadow: 0 0 0 0 rgba(35,90,228,0); }}
    }}
    .step-trail-label {{
...
if result:
    ...
    with st.expander("Annex"):
        annex_view = st.radio(
            "View", ["Raw vendor responses", "Canonical model", "Full API response"],
